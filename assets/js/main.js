...
var section = 'intro'
function saveSection(clickedSection) {
	section = clickedSection
	console.log(section)
	sessionStorage.setItem('section', clickedSection)
}
function loadSection() {
	console.log(`index.html#${section}`)
	window.location = `index.html#${sessionStorage.getItem('section') || ''}`
}
